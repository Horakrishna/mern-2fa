...
const ResetPassword = () => {
  ...
  return (
    <div  className='flex items-center justify-center min-h-screen  bg-gradient-to-br from-blue-200 to-purple-400 gap-10'>
...

        {
          !isEmailSent &&
            ...
            <p className='text-center mb-6 text-indigo-300 '>Enter your registered  Emmail Address</p>
        ...
        <p className='text-center mb-6 text-indigo-300 '>Enter 6-Digit Code Sent to your Emmail Id</p>
