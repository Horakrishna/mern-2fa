...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
        ...
        <h2 className='text-3xl sm:text-5xl font-semibold mb-4'>Well come to our App</h2>
        <p className='mb-8 max-w-md'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius enim eveniet eligendi veritatis, quod sit!</p>
